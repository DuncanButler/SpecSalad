...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("1 - =", "0", new string[0])]
        [NUnit.Framework.TestCaseAttribute("1 + = =", "3", new string[0])]
        [NUnit.Framework.TestCaseAttribute("1 + 1 = 5 + =", "10", new string[0])]
